...
namespace Asp_.NetCore.Controllers
{
    public class AlumnoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CursoId,Id,Nombre,Dirección")] Alumno alumno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("CursoId,Id,Nombre,Dirección")] Alumno alumno)
        {
            if (id != alumno.Id)
            {
                return NotFound();
